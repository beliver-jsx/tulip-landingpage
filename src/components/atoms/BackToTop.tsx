...
const BackToTop = () => {
    ...
    return (
        <div className="mt-[15rem]">
            <OutlineText onClick={scrollToTop} text="Back to top" classNames="4xl:text-[12rem]  3xl:text-[112px] 2xl:text-[112px] xl:text-[96px] lg:text-[96px] md:text-[80px] text-[52px] font-[800] text-center cursor-pointer w-full" />
